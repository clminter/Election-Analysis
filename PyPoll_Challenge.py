...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_dict:
        ...
        cnty_votes = county_dict.get(county_name)

        
        # 6c: Calculate the percentage of votes for the county.
        vote_percentage = float(cnty_votes) / float(total_votes) * 100
        county_results=(
            f"{county_name}: {vote_percentage:.1f}% ({cnty_votes:,})\n")
        ...
        if (cnty_votes > county_votes):
            county_votes = cnty_votes
